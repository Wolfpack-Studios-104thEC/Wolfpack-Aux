...
class CfgVehicles
{
	...
	class 104th_3AS_LAAT_Turrets_Base: 3as_LAAT_Mk1
	{
		...
		side = WEST;
		//Specific Defines:
		canFloat = true; //Defines if the vehicle will sink in the water or not. This is used here to prevent water damage
		enableSweep = true; //Enables AI to sweep over the target as a method of attack.
		enableGPS = true; //Enables the crew to use GPS and Map even if they do not have one in their inventory.
