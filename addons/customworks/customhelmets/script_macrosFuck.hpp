...
//ARC
	...
	hiddenSelectionsMaterials[] = {"\z\wps\addons\helmets\data\arc\Phase2ARC.rvmat", "\z\wps\addons\helmets\data\arc\ARCLight.rvmat",QPATHTOF(data\visor\##color##\Visor##color##.rvmat)};\
    /*picture = QPATHTOF(data\icon\Icon##name##_co.paa);*/ \
	/*class XtdGearInfo { \
		model = QGVAR(arc_custom); \
		camo = QUOTE(name); \
...
//ARF
	...
	hiddenSelectionsMaterials[] = {QPATHTOF(data\arf\ARF.rvmat),QPATHTOF(data\visor\##color##\Visor##color##.rvmat)};\
    /*picture = QPATHTOF(data\icon\Icon##name##_co.paa);*/ \
	/*class XtdGearInfo { \
		model = QGVAR(arf_custom); \
		camo = QUOTE(name); \
...
#define BARC_HELMET_RANK_MACRO(name)\
	...
	hiddenSelectionsMaterials[] = {QPATHTOF(data\barc\Phase2BARC.rvmat),QPATHTOF(data\visor\##color##\Visor##color##.rvmat)};\
    /*picture = QPATHTOF(data\icon\Icon##name##_co.paa);*/ \
	/*class XtdGearInfo { \
		model = QGVAR(barc_custom); \
		camo = QUOTE(name); \
...
#define ENGINEER_HELMET_RANK_MACRO(name)\
	...
	hiddenSelectionsMaterials[] = {QPATHTOF(data\engineer\Phase2Engineer.rvmat),QPATHTOF(data\engineer\light\EngineerLight_co.paa),QPATHTOF(data\visor\##color##\Visor##color##.rvmat)};\
    /*picture = QPATHTOF(data\icon\Icon##name##_co.paa);*/ \
	/*class XtdGearInfo { \
		model = QGVAR(engineer_custom); \
		camo = QUOTE(name); \
...
//Pilot
	...
	scope = 2;\
	displayName = QUOTE([104th] Pilot Helmet(name));\
	hiddenSelectionsTextures[] = {QPATHTOF(data\pilot\custom\Phase2Pilot##name##_co.paa), QPATHTOF(data\pilot\Phase2PilotLower_co.paa), QPATHTOF(data\visor\visor_co.paa)};\
    /*picture = QPATHTOF(data\icon\Icon##name##_co.paa);*/ \
	/*class XtdGearInfo { \
	...
	scope = 2;\
	displayName = QUOTE([104th] Pilot Helmet(name)); \
	hiddenSelectionsTextures[] = {QPATHTOF(data\pilot\custom\Phase2PilotUpper##name##_co.paa), QPATHTOF(data\pilot\Phase2PilotLower_co.paa), QPATHTOF(data\visor\##color#\visor##color##_co.paa)};\
	hiddenSelectionsMaterials[] = {QPATHTOF(data\pilot\Phase2PilotUpper.rvmat), QPATHTOF(data\pilot\Phase2PilotLower.rvmat), QPATHTOF(data\visor\##color##\Visor##color##.rvmat)};\
    /*picture = QPATHTOF(data\icon\Icon##name##_co.paa);*/\
	/*class XtdGearInfo { \
		model = QGVAR(pilot_custom); \
		camo = QUOTE(name); \
	...
	displayName = QUOTE([104th] Phase 1 Helmet(name));\
	hiddenSelectionsTextures[] = {QPATHTOF(data\phase1\custom\Phase1##name##_co.paa), QPATHTOF(data\visor\visor_co.paa)};\\
	hiddenSelectionsMaterials[] = {QPATHTOF(data\phase1\Phase1.rvmat), QPATHTOF(data\visor\##color##\Visor##color##.rvmat)};\
    /*picture = QPATHTOF(data\icon\Icon##name##_co.paa);*/ \
	/*/*class XtdGearInfo { \
		model = QGVAR(phase1_custom); \
		camo = QUOTE(name); \
